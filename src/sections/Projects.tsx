...
const portfolioProjects = [
  ...
  },
  {
    ...
    results: [
      { title: "Dashboard with Portfolio Insights" },
      { title: "Analyze Stocks with Graphs" },
      { title: "Track Apple to Tesla" },
    ],
    link: "https://portfolio-nine-chi-91.vercel.app/",
    ...
    <section id="projects" className="pb-16 lg:py-24">
      <div className="container">
        <SectionHeader
          ...
          description="Witness how I bring ideas to life, crafting immersive and dynamic digital experiences! 🚀✨"
        />
        <div className="mt-10 md:mt-20 flex flex-col gap-20 relative">
